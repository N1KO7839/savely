...
const Singup = () => {
    ...
    return (
        <div className="flex flex-col min-h-screen justify-center items-center bg-[#111827] h-screen">
            <div id="container" className="flex flex-col justify-center items-center bg-[#1f2937] h-3/4 w-5/6 xl:w-1/2 2xl:w-5/12 rounded-3xl relative">
                ...
                <h1 className="text-white font-Overpass font-bold text-6xl">Singup</h1>
                <div className="flex flex-col gap-7 w-10/12 pt-16">
                    ...
                    <div className="relative w-full">
                        <input ref={passwordConfirmRef} className="text-white text-center w-full bg-white/0 border border-[#777F8B] py-1.5 rounded-xl" type="password" name="passwordConfirm" id="passwordConfirm" placeholder="Confirm your password" />
                ...
                <div className='flex items-center gap-2 absolute bottom-2 m-4'>
                    ...
                    <Link to={"/login"} className='font-SignikaNegative font-bold text-xs mobileL:text-sm tablet:text-base text-[#5c90f2]'>
                        here
                    </Link>
                </div>
            </div >
