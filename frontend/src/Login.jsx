            ...
            <div id="container" className="flex flex-col justify-center items-center bg-[#1f2937] h-2/3 w-5/6 xl:w-1/2 2xl:w-5/12 rounded-3xl relative">
                ...
                <div className="flex flex-col gap-5 w-10/12 pt-4">
                    ...
                    <div className='flex items-center justify-center gap-4'>
                        <button className="font-SignikaNegative font-medium text-xs mobileL:text-sm lg:text-lg text-white w-1/2 h-10 rounded-lg border-2 border-[#727eeb] bg-[#727eeb] hover:bg-transparent transition-all duration-300">Login to your account</button>
                        <button className="font-SignikaNegative font-medium text-xs mobileL:text-sm lg:text-lg text-white w-1/2 h-10 rounded-lg bg-transparent border-2 border-[#727eeb] hover:bg-[#727eeb] transition-all duration-300">Forgot password?</button>
                    </div>
                </div>
